...
alias gamx='~/bin/gamadv-xtd/gam'
alias gamprt='~/bin/gamprt/gam'
alias updategamx='bash <(curl -s -S -L https://git.io/vMHsV) -l -d ~/bin/'
alias updategam='bash <(curl -s -S -L https://git.io/install-gam) -l'
...
export PATH=/home/lstrohm/perl5/bin:/usr/sbin:/usr/local/opt/qt/bin::/usr/local/bin:/usr/bin:/bin:/home/lstrohm/bin:/usr/local/sbin:/usr/sbin:/home/lstrohm/bin/gyb
