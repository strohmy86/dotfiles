...
complete -c bumblebeed -l driver --description 'the driver to use for the nvidia card.  Valid values are nouveau and nvidia.'
complete -c bumblebeed -s m -l module-path --description 'ModulePath to use for Xorg (only useful for nvidia).'
complete -c bumblebeed -s k -l driver-module --description 'Name of kernel module to be loaded if different from the driver.'
complete -c bumblebeed -l pm-method --description 'method to use for disabling the discrete video card, valid values are auto, b…'
...
complete -c bumblebeed -l debug --description 'show all logging messsages by setting the verbosity level to the maximum.'
...
complete -c bumblebeed -l version --description 'output version information and exit REPORTING BUGS Report bugs on <http://Bum…'
