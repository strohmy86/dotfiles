...
gauge = {
{
    ...
    graph_bg_colour=0x222222,      graph_bg_alpha=0.3,
    graph_fg_colour=0x222222,      graph_fg_alpha=0.0,
    hand_fg_colour=222222,       hand_fg_alpha=1.0,
    txt_radius=40,
    txt_weight=1,                  txt_size=8.0,
    txt_fg_colour=0x555555,        txt_fg_alpha=0.8,
...
},
{
    ...
    graph_bg_colour=0x222222,      graph_bg_alpha=0.3,
    graph_fg_colour=0x222222,      graph_fg_alpha=0.0,
    hand_fg_colour=0x222222,       hand_fg_alpha=1.0,
    txt_radius=70,
    txt_weight=1,                  txt_size=8.0,
    txt_fg_colour=0x555555,        txt_fg_alpha=0.8,
