 ...
 *
 * The remote code is loaded from here: https://www.cloudhq.net/javascripts/chrome_extension_gmail_mail_tracker_packaged.js
 *
 */

g_server_url = "https://www.cloudhq.net/";
var version_date = new Date().toJSON().slice(0,10)
InboxSDK.loadScript(g_server_url + 'javascripts/chrome_extension_gmail_mail_tracker_packaged.js?v=' + version_date);
